...
priorities, and energy-linked compute policy.

It becomes visible when institutions decide who can run large-scale training or inference,
under which standards, and at what cost.
...
當機構開始決定誰可以執行大規模訓練或推論、依何種標準、並以何種成本執行時，
這個問題就會變得可見。
